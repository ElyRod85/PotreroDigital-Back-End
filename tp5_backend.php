...
<body>
    ...
    <?php
        ...
        */
        ...
        foreach ($ejercicio4 as $index => $cadaCiudad) {
            echo "La ciudad con el índice $index tiene el nombre $cadaCiudad.<br>";
        }
        ...
        foreach ($ejercicio5 as $index => $cadaCiudad) {
            echo "El índice de $cadaCiudad es $index.<br>";
        }
